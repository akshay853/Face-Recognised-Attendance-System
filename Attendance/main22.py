...
from db import InsertStaffData,deletephotofromfolder,staffauthenication,viewORremovestaff,insertQuery,Display,removestaffdb,getStudentAttendance,studentdb,removestudents
...
class Mainwindow():
    ...
    def stafflogin(self):
        ...
        self.ui.buttonUpload.clicked.connect(self.updateAttendance)
        self.ui.Faculty_Name_1.setText(self.currentfaculityname);    # To open Settings UI
